...
import Joi from '../lib/index.js';
import * as Lab from '@hapi/lab';
import Legacy from '@hapi/joi-legacy-test';

import * as Helper from './helper.js';

const legacyPkg = JSON.parse(readFileSync(new URL('../node_modules/@hapi/joi-legacy-test/package.json', import.meta.url), 'utf8'));
...
describe('cast', () => {
    ...
    describe('compile()', () => {
        ...
        it('errors on legacy schema', () => {
            ...
            expect(() => Joi.compile(schema)).to.throw(`Cannot mix different versions of joi schemas: ${legacyPkg.version} ${pkg.version}`);
