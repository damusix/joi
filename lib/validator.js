import { assert, clone, ignore, reach } from '@hapi/hoek';
...
export const entry = function (value, schema, prefs) {
...
export const entryAsync = async function (value, schema, prefs) {
...
export const standard = function (value, schema) {


    if (schema.isAsync()) {
        return entryAsync(value, schema);
    }
...
internals.entry = function (value, schema, prefs) {
    ...
    const result = validate(value, schema, state, prefs);
...
export const validate = function (value, schema, state, prefs, overrides = {}) {
