...
import * as Bossy from '@hapi/bossy';
...
if (args.compare) {
    try {
        compare = JSON.parse(readFileSync(args.compare, 'utf8'));
    }
    catch {
        // Ignore error
    }
...
const Joi = (await import('../lib/index.js')).default;
...
Suite
    .on('complete', (benches) => {
        ...
        if (args.save) {
            ...
            writeFileSync(args.save, JSON.stringify(report, null, 2), 'utf8');
        }
